...
Flutter, we need to create its Dart equivalent.
...
This is configurable from the CMS. Each layout is a different configuration and
can contain specific parameters to tweak the visual representation.
:::

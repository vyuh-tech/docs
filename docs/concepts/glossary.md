...
and APIs. Such features qualify as _**Mini Apps**_.
...
::: info
A Plugin in the context of Vyuh is just a pluggable API and should not be
confused with
[plugin](https://docs.flutter.dev/packages-and-plugins/using-packages) from

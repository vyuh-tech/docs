      ...
      '/docs/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'FAQ', link: '/docs/concepts/faq' },
          ],
        },
        {
          text: 'Guides',
          collapsed: false,
          items: [
            { text: 'Tutorial', link: '/docs/guides/tutorial' },
            {
              text: 'Features',
              collapsed: true,
              items: [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Custom Plugins', link: '/docs/guides/custom-plugins' },
                { text: 'Feature Flags', link: '/docs/guides/feature-flags' },
                { text: 'State Management (MobX)', link: '/docs/guides/mobx-state-management' },
              ],
            },
            {
              text: 'Platform',
              collapsed: true,
              items: [
                { text: 'Platform Customization', link: '/docs/guides/platform-customization' },
                { text: 'Internationalization', link: '/docs/guides/i18n' },

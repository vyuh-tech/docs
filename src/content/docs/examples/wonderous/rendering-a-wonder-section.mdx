...
<Aside>
  Notice that all of this is **completely type-safe** and ensures you get the
  **best developer-experience** when dealing with CMS content.
</Aside>

```dart title="section.dart"

...
![Wonderous Routes](images/wonderous-routes.png)
...
The real magic is in the **`wonderPathResolver`** (shown in mark `1` above) that
looks at the specific `GoRoute` path and identifies the corresponding
_CMS-path_.&#x20;
...
<Steps>
1. **Locate the Taj Mahal Card**
  ![](images/locate-taj-mahal-card.png)

2. **Edit the Navigation action** ![](images/edit-navigation.png)

3. **Link to Taj Mahal details** ![](images/link-to-taj-mahal.png)
...
<Aside>
  On the **CMS Studio**, the easiest way to do this is **Duplicate** the card
  and just change the Navigation action!
</Aside>
...
![Page structure of the Details route](images/details-route.png)
...
![Navigating a single wonder in Vyuh](images/managing-wonders.png)

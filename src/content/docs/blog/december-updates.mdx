...
cover:
  alt: Cover Image
  image: ./images/december-updates.png
---
...
which you can explore on our [documentation site](/guides/events).
...
Read more about modifiers on the
[documentation site](/guides/cms/custom-modifier).

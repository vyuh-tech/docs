---
title: Layouts
description: Understanding the structure and usage of layouts in the Vyuh React feature system
---
...
Layouts in the Vyuh framework provide a powerful way to control the visual presentation of [content blocks](/react/guides/content-blocks) without changing their underlying data. They separate the content structure from its visual representation, enabling flexible and dynamic user interfaces.
...
Now that you understand layouts in Vyuh, learn about:

...
<PubBadge name="vyuh_feature_system" />
...
special kind of Content Item. The system feature includes two kinds of routes:
...
<Aside title={'API Configurations'}>
...
_GraphQL_ or a _Streaming API_ and render it the way you please!

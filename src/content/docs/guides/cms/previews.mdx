---
title: Using Content Previews
description:
  Learn how to use the Preview feature in Vyuh to test and visualize your
  content layouts
---
...
import contentPlaygroundEntryImage from './images/content-playground-entry.png'
import playgroundVideo from './images/playground.mp4'
...
- **Content Previews**: Generate sample content without needing actual Sanity.io
  data
...
Similarly, layouts can also define previews to demonstrate how they'll render
content:

<Tabs>
  <TabItem label="Default Layout">
...
```
  ...
  <TabItem label="List Item Layout">
...
2. Navigate to the Developer Tools section (hosted on `/developer` route)
3. Select "Content Playground", which is available as an icon in the top-right
   corner of the Developer Tools main page.

<Image
  src={contentPlaygroundEntryImage}
  alt="Vyuh Content Playground"
  height={400}
/>
...
If your previews aren't working as expected:
...
development experience and minimize the need for actual content in Sanity.io.
